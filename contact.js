...
$(document).ready(function() {
    ...
    $('#next1').click(function() {
        ...
        if( !$('#name').val() ) {
            ...
            setTimeout(function () { hideInput(); }, 900);
            ...
            setTimeout(function () { showServices(); }, 1000);
            
            function showServices() {
                $('.input-services').css('display', 'block').css('animation', 'panin 1.5s ease-in-out');
    ...
    $('#next2').click(function() {
        ...
        if( !$('#website').is(':checked') && !$('#app').is(':checked')) {
            ...
            setTimeout(function () { hideInput(); }, 1000);
